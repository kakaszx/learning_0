...
async function manipularSubmissaoFormulario(event) {
  ...
  if (!validarConteudo(conteudoSemEspacos)) {
    alert("So é permitido apenas letras e espaços com no mínimo 8 caracteres");
    return;
  }

  if (!validarAutoria(autoriaSemEspacos)) {
    alert(
      "So é permitido apenas letras e espaços com no mínimo 8 a 15 caracteres"
    );
    return;
  }
